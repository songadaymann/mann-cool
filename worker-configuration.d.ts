/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: d53e9fce9ea8d7f88a6b6d167dc4f165)
// Runtime types generated with workerd@1.20260515.1 2026-07-15 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	PLATFORM_READ_SOURCE: "d1";
	PLATFORM_DUAL_WRITE_UPSTASH: "true";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PLATFORM_READ_SOURCE" | "PLATFORM_DUAL_WRITE_UPSTASH" | "PATREON_URL" | "TIP_URL">> {}
}
